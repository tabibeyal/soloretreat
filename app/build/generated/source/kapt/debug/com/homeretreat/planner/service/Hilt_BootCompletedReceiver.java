  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((BootCompletedReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectBootCompletedReceiver(UnsafeCasts.<BootCompletedReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
