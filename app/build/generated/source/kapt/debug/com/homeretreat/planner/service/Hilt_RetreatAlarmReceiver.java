...
public abstract class Hilt_RetreatAlarmReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((RetreatAlarmReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectRetreatAlarmReceiver(UnsafeCasts.<RetreatAlarmReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
