...
public abstract class Hilt_RetreatStopReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((RetreatStopReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectRetreatStopReceiver(UnsafeCasts.<RetreatStopReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
