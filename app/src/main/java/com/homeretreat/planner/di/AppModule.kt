...
object AppModule {
    ...
    fun provideRetreatRepository(
        retreatConfigDao: com.homeretreat.planner.data.local.dao.RetreatConfigDao,
        checklistItemDao: com.homeretreat.planner.data.local.dao.ChecklistItemDao,
        scheduleBlockDao: com.homeretreat.planner.data.local.dao.ScheduleBlockDao,
        meditationSessionDao: com.homeretreat.planner.data.local.dao.MeditationSessionDao,
        journalEntryDao: com.homeretreat.planner.data.local.dao.JournalEntryDao,
        mealLogDao: com.homeretreat.planner.data.local.dao.MealLogDao,
        preceptLogDao: com.homeretreat.planner.data.local.dao.PreceptLogDao,
        dhammaTalkDao: com.homeretreat.planner.data.local.dao.DhammaTalkDao
    ...
    fun provideMealLogRepository(
        mealLogDao: com.homeretreat.planner.data.local.dao.MealLogDao
    ): com.homeretreat.planner.data.repository.MealLogRepository =
        com.homeretreat.planner.data.repository.MealLogRepository(mealLogDao)

    @Provides
    @Singleton
    fun provideMeditationSessionRepository(
        meditationSessionDao: com.homeretreat.planner.data.local.dao.MeditationSessionDao
    ): com.homeretreat.planner.data.repository.MeditationSessionRepository =
        com.homeretreat.planner.data.repository.MeditationSessionRepository(meditationSessionDao)
}