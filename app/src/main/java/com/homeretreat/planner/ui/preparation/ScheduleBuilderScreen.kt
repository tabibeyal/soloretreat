...
import com.homeretreat.planner.ui.components.ScheduleBlockItem
    ...
    Scaffold(
        ...
        .padding(horizontal = 16.dp)
            ...
            validationResult?.let { result ->
                when (result) {
                    is com.homeretreat.planner.data.repository.ScheduleRepository.ScheduleValidationResult.Valid -> {
                        Text(
                            "Schedule is valid",
                    ...
                    is com.homeretreat.planner.data.repository.ScheduleRepository.ScheduleValidationResult.NoBlocks -> {
                        Text(
                    ...
                    is com.homeretreat.planner.data.repository.ScheduleRepository.ScheduleValidationResult.Overlap -> {
                        Text(
                    ...
                    is com.homeretreat.planner.data.repository.ScheduleRepository.ScheduleValidationResult.MealTooLate -> {
                        Text(
